export const el = {
  ...
  runStepReview: document.getElementById("run_step_review"),
  ...
  reviewProvider: document.getElementById("review_provider"),
  googleVisionProjectId: document.getElementById("google_vision_project_id"),
  googleVisionFeature: document.getElementById("google_vision_feature"),
  reviewMinMatchConfidence: document.getElementById("review_min_match_confidence"),
  reviewMinOcrChars: document.getElementById("review_min_ocr_chars"),
  reviewMaxBoundaryAdjustSec: document.getElementById("review_max_boundary_adjust_sec"),
  reviewHealthCheck: document.getElementById("review-health-check"),
  reviewHealthStatus: document.getElementById("review-health-status"),
  reviewHealthMetaToggle: document.getElementById("review-health-meta-toggle"),
  reviewHealthMetaWrap: document.getElementById("review-health-meta-wrap"),
  reviewHealthMeta: document.getElementById("review-health-meta"),
