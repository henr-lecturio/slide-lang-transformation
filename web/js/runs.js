...
function getDownloadLinks(detail, { includeVideo = true, includeNonVideo = true } = {}) {
  ...
  return [
    ...(includeNonVideo ? [
      ...
      { label: "Slide OCR JSON", url: detail.review_slide_ocr_json_url, name: "slide_ocr.json" },
      { label: "Slide OCR CSV", url: detail.review_slide_ocr_csv_url, name: "slide_ocr.csv" },
      { label: "Slide Voice Alignment JSON", url: detail.review_slide_voice_alignment_json_url, name: "slide_voice_alignment.json" },
      { label: "Slide Voice Alignment CSV", url: detail.review_slide_voice_alignment_csv_url, name: "slide_voice_alignment.csv" },
      { label: "Reviewed Timeline JSON", url: detail.reviewed_timeline_json_url, name: "reviewed_timeline.json" },
      { label: "Reviewed Timeline CSV", url: detail.reviewed_timeline_csv_url, name: "reviewed_timeline.csv" },
